...
<br/>
<body>
<form align="center" action="insert.jsp" name="myForm"><font size ="6">
<fieldset style="width:70px;">
<legend style="font-family:verdana;font-size:100%;color:blue" align="center"> <b>Company's Account Details</b></legend><br/>
<table width="620" align="center">
<tr><td><b>
Username: </td>
<td align="left"><input type="text" name="nam" maxlength="10" required="required"/></b>
<br/></td></tr>
<tr><td><b>Password: </td>
<td><input type="password" name="pass" /></b><br/></td></tr>
<tr><td><b>Retype Password: </td>
<td><input type="password" name="repass" /></b><br/></td></tr>
<tr><td><b>Mobile Number: </td><td><input type="text" name="mno" maxlength="10" required="required"/></b>
<br/></td></tr>
</table>
</fieldset>
<br/>
