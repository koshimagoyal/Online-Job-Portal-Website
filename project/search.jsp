...
<br/><br/>
<div style="height:1200px; background-color:#FFA07A;">
<br/>
...
<form class="form-wrapper-2 cf" action=" " name="myForm"><font size ="6">
<fieldset style="width:70px;">
<legend style="font-family:verdana;font-size:100%;color:blue;" align="center"><b>
<table style="background-color: white;">
<tr><td>
<img src="images (2).png" style="height:55px; width:70px;"><font size="7" color="blue" face="arial"><b><i>Search Jobs</b></i></font>
</td></tr>
</table></b></legend><br/>
...
<% 
   ...
   %>
   <% 
	String p = (String)request.getAttribute("Ni");
	if(p!=null)
	out.print(p);
...
<br/></td></tr>
<tr><td><b><font size="5">Job Function:</font></td>
<td><input type="text" name="jobf"></td>
</b></td></tr>
</table>
<br/>
	...
	try
	{
		...
		else
		{
			...
			<tr>
				...
				<td><%= rs.getString("cfun") %></td>
				<td><%= rs.getString("cdes") %></td>
				<td><%= rs.getString("jdes") %></td>
